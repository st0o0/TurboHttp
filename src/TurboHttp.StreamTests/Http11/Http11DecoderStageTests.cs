...
public sealed class Http11DecoderStageTests : StreamTestBase
{
    ...
    [Fact(DisplayName = "RFC-9112-§4: Status-Line decoded to StatusCode and Version11")]
    ...
    [Fact(DisplayName = "RFC-9112-§6.1: Content-Length body decoded correctly")]
    ...
    [Fact(DisplayName = "RFC-9112-§7.1: Chunked body decoded correctly")]
    ...
    [Fact(DisplayName = "RFC-9112-§4: Response header decoded to response.Headers")]
