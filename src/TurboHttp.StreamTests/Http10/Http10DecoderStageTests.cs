...
public sealed class Http10DecoderStageTests : StreamTestBase
{
    ...
    [Fact(DisplayName = "RFC-1945-§6.1: Status-Line decoded to StatusCode and Version")]
    ...
    [Fact(DisplayName = "RFC-1945-§7.1: Response header decoded to response.Headers")]
    ...
    [Fact(DisplayName = "RFC-1945-§6.1: 404 response decoded to HttpStatusCode.NotFound")]
    ...
    [Fact(DisplayName = "RFC-1945-§7.2: Response split across two TCP chunks reassembled")]
